...
## Hardware Actuators and Protection Architecture
...
|---|---|---|
| **SG90 Servo Actuator** | `D6` | **Vehicle Safe-Stop System**: Serves as throttle/brake lockout. Rotates from **90 deg (Normal Drive)** to **0 deg (Emergency Safe-Stop)** upon intrusion detection. |
...
| **4 Tactical Pushbuttons** | `D2`-`D5` | Hardware traffic selectors for Normal Traffic, DoS Attack, Fuzzy Attack, and Impersonation. |
...
2. Replace `diagram.json` with the contents of `stm32_wokwi/diagram.json`.
